          ...
          <div className="sm:flex justify-end">
            <div className="my-5 gm:flex  gap-6 xl:my-0 bg-white rounded-2xl py-4 items-center px-14">
              ...
              <div className="">
                ...
                <p className='font-popping my-4 gm:my-0 text-[13px] text-[#333333]'>click the button and follow the <br /> instruction</p>
                <div className="flex justify-end">
                  <button className='font-popping bg-[#B8E8D1] rounded-full py-2 text-[13px] px-6'>Click here</button>
                </div>
              </div>
            </div>
          </div>
